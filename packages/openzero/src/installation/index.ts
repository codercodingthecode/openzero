...
declare global {
  const OPENZERO_VERSION: string
  const OPENZERO_CHANNEL: string
}
...
export namespace Installation {
  ...
  export const VERSION = typeof OPENZERO_VERSION === "string" ? OPENZERO_VERSION : "local"
  export const CHANNEL = typeof OPENZERO_CHANNEL === "string" ? OPENZERO_CHANNEL : "local"
  export const USER_AGENT = `opencode/${CHANNEL}/${VERSION}/${Flag.OPENZERO_CLIENT}`
