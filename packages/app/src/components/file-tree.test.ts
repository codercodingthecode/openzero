...
beforeAll(async () => {
  ...
  mock.module("@openzero/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@openzero/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@openzero/ui/icon", () => ({ Icon: () => null }))
  mock.module("@openzero/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
